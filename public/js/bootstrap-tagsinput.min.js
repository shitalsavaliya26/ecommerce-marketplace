...
! function(a) {
    ...
    function b(b, c) {
        ...
        this.nameText = b.hasAttribute("name") ? this.$element.attr("name") : "", 
        this.inputSize = Math.max(1, this.placeholderText.length), 
        this.$container = a('<div class="bootstrap-tagsinput ' + this.nameText + '" ></div>'), 
        this.$input = a('<input type="text" id="' + this.nameText + '" name="' + this.nameText + '_' + this.nameText + '"/>').appendTo(this.$container), this.$element.after(this.$container);
        var d = (20) + "em";
