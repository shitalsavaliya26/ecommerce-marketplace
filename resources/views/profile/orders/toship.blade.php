<div class="col-12 mt-2  table-responsive" id="ship">
        ...
        <tbody>
            @foreach($toship as $order)
                <tr>
                    ...
                    <td>RM {{ number_format($order->getorderpricebyidwithoutshipping($order->id),2)}}{{-- +$order->shipping_charge --}}</td>
                    <td>{{trans('label.to_ship')}}</td>
                    <td  data-toggle="collapse" data-target="#order{{$order->id}}"
                        ...
                        <img src="{{ asset('assets/images/minus.png') }}" class="select-arrow d-none" style="position: relative;" alt="">
                    </td>
                </tr>
                <tr id="sub">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-12">
                                                                <div class="m-dropzone dropzone m-dropzone--primary productDropZonenew" id="productDropZonenew{{$product->id}}"action="/" method="post">
                                                                    <div class="m-dropzone__msg dz-message needsclick">
                                                                        ...
                                                                        <span class="m-dropzone__msg-desc">Allowed only imagefiles</span>
                                                                    </div>
    ...
    <div class="col-12">
        {{ $toship->render('vendor.default_paginate') }}
    </div>
</div>
