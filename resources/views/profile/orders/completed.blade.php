<div class="col-12 mt-2  table-responsive"  id="completed">
                                    ...
                                    @foreach($order->orderProduct as $product)
                                        @if($product->productdetail && $product->productdetail != null)
                                            <tr>
                                                ...
                                                @if($order->status == 'delivered')
                                                    <td id="completed_{{$product->productdetail->id}}_{{$product->id}}">
    ...
    <div class="col-12">
        {{ $complated->render('vendor.default_paginate') }}
    </div>
</div>

<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    aria-hidden="true" id="completedReviewRatingModal">
