...
<div class="m-content">
    <div class="m-portlet m-portlet--mobile dataTables_wrapper dt-bootstrap4">
        ...
        <div class="row">
            ...
            action="{{ route('seller.products.update',App\Helpers\Helper::encrypt($product->id)) }}" enctype="multipart/form-data" id="m_form">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
                        ...
                        <div class="col-lg-12">
                            <div class="m-form__section m-form__section--first">
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-4 form-group m-form__group ">
                                        ...
                                        <div class="m-input-icon m-input-icon--right">
                                            ...
                                            data-live-search="true" multiple="multiple" name="category[]" id="category">
                                            @foreach ($categories as $category)
                                            <option value="{{ $category->id }}"
                                                @if (in_array($category->id, $selectedcategories)) selected="selected"  @endif>{{ $category->name }}
                                            </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-lg-4 form-group m-form__group ">
                                    ...
                                    <div class="m-input-icon m-input-icon--right">
                                        ...
                                        name="sku" placeholder="Enter sku code" value="{{ $product->sku }}" autofocus>
                                        @if ($errors->has('sku'))
                                        <span class="helpBlock">
                            ...
                            <div class="form-group m-form__group row">
                                <div class="col-lg-12 form-group m-form__group ">
                                    ...
                                    <div class="m-input-icon m-input-icon--right">
                                        <textarea type="text" class="form-control m-input txarea-height summernote"
                                        ...
                                        @endif
                                            ...
                                            <div class="form-group m-form__group " id="daynamic_customer_price">
                                                @if (count($daynamic_customer_price) <= 0)
                                                    <div class="row col-lg-12 ">
                                                        ...
                                                        <div class="col-lg-4 form-group m-form__group ">
                                                            <label for="daynamic_qty">Customer price</label>
                                                            <div class="input-group">
                                                                ...
                                                                placeholder="Enter customer price" min="0.01"
                                                                autofocus>
                                                ...
                                                @else
                                                    @foreach ($daynamic_customer_price as $customer_product_price)
                                                        <div class="row col-lg-12 " id="edit_row_{{ $customer_product_price->id }}">
                                                            <div class="col-lg-4 form-group m-form__group pt15">
                                                                <label for="daynamic_qty">Qty</label>
                                                                <div class="input-group">
                                                                    <input type="text" class="form-control m-input"
                                                                        name="customer_qty_edit[]"
                                                                        value="{{ $customer_product_price->qty }}"
                                                                        placeholder="Enter Quantity of product" min="2"
                                                                        autofocus required>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4 form-group m-form__group ">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control m-input"
                                                                    value="{{ $customer_product_price->price }}"
                                                                    name="customer_daynamic_price_edit[]"
                                                                    placeholder="Enter customer price" min="0.01"
                                                            ...
                                                            <div class="col-lg-4 form-group m-form__group">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    class="btn btn-danger edit_remove_btn"
                                                                    data-id="{{ $customer_product_price->id }}">Remove</button>
                                                                </div>
                                                            </div>
                                                            <input type="hidden" name="customer_daynamic_id[]"
                                                            value="{{ $customer_product_price->id }}">
                                                        </div>
                                                    @endforeach
                                                    <div id="remove_edit_price">
                                                    </div>
                                                    </div>
                                                    <div class="col-lg-4 form-group m-form__group">
                                                        <label for=""></label>
                                            ...
                                            <div class="form-group m-form__group row">
                                                <div class="col-lg-4">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        ...
                                                        id="videolink" value="videolink" @if ($product->type == 'videolink') checked  @endif>
                                                        <label class="form-check-label" for="link">Link</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="type"
                                                        id="videoupload" value="videoupload" @if ($product->type == 'videoupload') checked  @endif>
                                                        <label class="form-check-label" for="videoupload">Video
                                                        Upload</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="type"
                                                        id="none" value="none" @if ($product->type == '') checked @endif>
                                                ...
                                                <div id="url_place"
                                                class="col-lg-4 col-md-4 col-sm-12 mt-4 @if ($product->type == 'videolink') @else d-none @endif">
                                                <label class="col-form-label">Video Url(Must add embed url)</label><br>
                                                <div class="m-input-icon m-input-icon--right">
                                                    <input type="url" class="form-control m-input" id="video_url"
                                                    name="video_url" placeholder="Enter video url" @if ($product->type == 'videolink')
                                                    value="{{ $product->video }}"
                                                    @else
                                                    value="{{ old('video_url') }}"
                                                    @endif autofocus>
                                            ...
                                            <div id="video_place" class="col-lg-4 col-md-4 col-sm-12 mt-4 @if ($product->type == 'videoupload') @else d-none @endif">
                                                ...
                                                <div class="m-input-icon m-input-icon--right">
                                                    ...
                                                    @if ($product->type == 'videoupload')
                                                    value="{{ basename($product->video) }}"
                                                    @endif>
                                                    @if ($product->type == 'videoupload' && $product->video != '')
                                                    <a target="_blank" style="text-decoration: none;" href="{{ $product->video }}" >View previous uploaded video.</a>
                                                    @endif
                                                </div>
                                            </div>
                                            {{-- <div id="video_thumb"
                                            class="col-lg-4 col-md-4 col-sm-12 mt-4 @if ($product->type == 'videoupload' || $product->type == 'videolink')) @else d-none @endif">
                                            <label class="col-form-label">Video Thumb</label><br>
                                            <div class="m-input-icon m-input-icon--right">
                                                <input type="file" class="form-control m-input" id="video_thumb"
                                                name="video_thumb">
                                                ...
                                                @if (($product->type == 'videoupload' || $product->type == 'videolink') && !empty($product->video))
                                                <a target="_blank" style="text-decoration: none;" href="{{ $product->video_thumb }}" download>View previous uploaded thumb.</a>
                                                @endif
                                            </div>
                                        </div> --}}
                                    </div>
                               ...
                               <!--      <div class="form-group m-form__group row">
                                        <div class="col-lg-3 col-md-3 col-sm-12 mt-4">
                                            <div class="m-input-icon m-input-icon--right mb-3">
                                            ...
                                            @if (!empty($product->photos_zip_file))
                                            <a target="_blank" style="text-decoration: none;" href="{{ $product->photos_zip_file }}" download>View previous uploaded file click here.</a>
                                            @endif
                                        </div>
                                    </div> -->
                                    {{-- end : Product zip --}}
                                    ...
                                    <div class="form-group m-form__group row">
                                        ...
                                        {{-- <div class="col-lg-3">
                                            ...
                                            <div class="m-checkbox-inline">
                                                <label class="m-checkbox">
                                                    <input type="checkbox" value="true" name="is_new"
                                                    @if ($product->is_new == 'true') checked @endif> New arrival
                                                    <span></span>
                                                </label>
                                            </div>
                                        </div> --}}
                                        <!-- <div class="col-lg-3 mt-5 mx-5">
                                            <div class="form-check form-check-inline">
                                                ...
                                                id="new_arrival" value="new_arrival" @if ($product->tag == 'new_arrival') checked  @endif>
                                                <label class="form-check-label" for="new_arrival">New arrival</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="tag"
                                                id="pwp" value="pwp" @if ($product->tag == 'pwp') checked  @endif>
                                                <label class="form-check-label" for="pwp">
                                                PWP</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="tag"
                                                id="none" value=""  @if (!$product->tag) checked  @endif>
                                        ...
                                        <div class="col-lg-2 mt-2">
                                            ...
                                            <div class="m-checkbox-inline">
                                                <label class="m-checkbox">
                                                    ...
                                                    @if ($product->is_featured == '1') checked @endif> Is featured product
                                                    <span></span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-lg-2 mt-2">
                                            ...
                                            <div class="m-checkbox-inline">
                                                <label class="m-checkbox">
                                                    <input type="checkbox" value="1" name="is_other"
                                                    @if ($product->is_other == '1') checked @endif> Is other product
                                                    <span></span>
                                                </label>
                                            </div>
                                        </div> -->
                                   ...
                                   <!--  <div class="form-group m-form__group row">
                                        <div class="col-lg-3 form-group">
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="cod" name="cod" value="1" @if ($product->cod == '1') checked @endif>
                                        ...
                                        <div class="col-lg-3 form-group"  id="displaycheckbox">
                                            <div class="form-check">
                                                ...
                                                @if ($product->displayhomescreen == '1') checked @endif>
                                                <label class="form-check-label mx-3" for="displayhomescreen">Is display home screen?</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 form-group">
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="free_shipping" name="free_shipping" value="1" @if ($product->free_shipping == '1') checked @endif>
                                                <label class="form-check-label mx-3" for="free_shipping">Allow free shipping?</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 form-group @if($product->free_shipping != '1') d-none @endif" id="agent_wallet">
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="deduct_agent_wallet" name="deduct_agent_wallet" value="1" @if ($product->deduct_agent_wallet == '1') checked @endif>
                                            ...
                                            <div class="form-group m-form__group row">
                                                <div class="col-lg-4 form-group m-form__group ">
                                                    <div class="form-group m-form__group">
                                                        ...
                                                        <select class="form-control " name="is_variation" id="is_variation"  @if($product->is_variation == '1') disabled @endif>
                                                            <option value="0" @if($product->is_variation == '0') selected @endif>Simple</option>
                                                            <option value="1"@if($product->is_variation == '1') selected @endif>Variable</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                            <div id="simple">
                                                <div class="form-group m-form__group row">
                                                    <div class="col-lg-6 form-group m-form__group ">
                                                        ...
                                                        <div class="m-input-icon m-input-icon--right">
                                                            <input type="text" class="form-control m-input" id="weight" name="weight"
                                                            placeholder="Enter weight" value="{{ $product->weight }}" autofocus>
                                                        ...
                                                        <div class="m-input-icon m-input-icon--right">
                                                            <div class="row">
                                                                <div class="col-lg-4">
                                                                    ...
                                                                    placeholder="Length" value="{{ $product->length }}" autofocus>
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <input type="text" class="form-control m-input" id="width" name="width" placeholder="Width"
                                                                    value="{{ $product->width }}" autofocus>
                                                                    @if ($errors->has('width'))
                                                                    <span class="helpBlock">
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <input type="text" class="form-control m-input" id="pheight" name="pheight" placeholder="Height"
                                                                    value="{{ $product->height }}"autofocus>
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-lg-4 form-group m-form__group ">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control m-input" id="customer_price" name="customer_price"
                                                            placeholder="Enter customer price" value="{{ $product->customer_price }}" min="0" autofocus>
                                                    ...
                                                    <div class="col-lg-4 form-group m-form__group ">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control m-input" id="sell_price" name="sell_price"
                                                            placeholder="Enter selling price" value="{{ $product->sell_price }}" min="0" autofocus>
                                                    ...
                                                    <div class="col-lg-4 form-group m-form__group ">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control m-input" id="customer_cost_price"
                                                            name="customer_cost_price" placeholder="Enter customer cost price"
                                                            value="{{ $product->cost_price }}" min="0" autofocus>
                                                            ...
                                                            <!-- <div class="col-lg-4 form-group m-form__group " >
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control m-input" id="staff_price" name="staff_price"
                                                                        placeholder="Enter staff price" value="{{ $product->staff_price }}" min="0" autofocus>
                                                        ...
                                                        <!-- <div class="col-lg-4 form-group m-form__group ">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control m-input" id="ex_price" name="ex_price"
                                                                    placeholder="Enter executive price" value="{{ $product->executive_leader_price }}" min="0" autofocus>
                                                        ...
                                                        <div class="col-lg-4 form-group m-form__group ">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control m-input" id="si_price" name="si_price"
                                                                    placeholder="Enter silver price" value="{{ $product->silver_leader_price }}" min="0" autofocus>
                                                        ...
                                                        <div class="col-lg-4 form-group m-form__group ">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control m-input" id="go_price" name="go_price"
                                                                    placeholder="Enter gold price" value="{{ $product->gold_leader_price }}" min="0" autofocus>
                                                        ...
                                                        <div class="col-lg-4 form-group m-form__group ">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control m-input" id="pl_price" name="pl_price"
                                                                    placeholder="Enter platinum price" value="{{ $product->plat_leader_price }}" min="0" autofocus>
                                                        ...
                                                        <div class="col-lg-4 form-group m-form__group ">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control m-input" id="di_price" name="di_price"
                                                                    placeholder="Enter diamon price" value="{{ $product->diamond_leader_price }}" min="0" autofocus>
                                                        ...
                                                        <div class="col-lg-4 form-group m-form__group ">
                                                            ...
                                                            <div class="m-input-icon m-input-icon--right">
                                                                <input type="text" class="form-control m-input" id="qty" name="qty"
                                                                placeholder="Enter quantity" value="{{ $product->qty }}" min="0" autofocus>
                                                                @if ($errors->has('qty'))
                                                                <span class="helpBlock">
                                                    ...
                                                    <!-- <div class="form-group m-form__group row">
                                                        ...
                                                        <div class="col-lg-4 form-group m-form__group ">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control m-input" value="{{ $product->executive_pv_point }}" pattern="(^100(\.0{1,2})?$)|(^([1-9]([0-9])?|0)(\.[0-9]{1,2})?$)"
                                                        ...
                                                        <div class="col-lg-4 form-group m-form__group ">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control m-input" value="{{ $product->silver_pv_point }}" pattern="(^100(\.0{1,2})?$)|(^([1-9]([0-9])?|0)(\.[0-9]{1,2})?$)"
                                                        ...
                                                        <div class="col-lg-4 form-group m-form__group ">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control m-input" value="{{ $product->golden_pv_point }}" pattern="(^100(\.0{1,2})?$)|(^([1-9]([0-9])?|0)(\.[0-9]{1,2})?$)"
                                                        ...
                                                        <div class="col-lg-4 form-group m-form__group ">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control m-input" value="{{ $product->platinum_pv_point }}" pattern="(^100(\.0{1,2})?$)|(^([1-9]([0-9])?|0)(\.[0-9]{1,2})?$)"
                                                        ...
                                                        <div class="col-lg-4 form-group m-form__group ">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control m-input" value="{{ $product->diamond_pv_point }}" pattern="(^100(\.0{1,2})?$)|(^([1-9]([0-9])?|0)(\.[0-9]{1,2})?$)"
                                                        ...
                                                        <div class="col-lg-4 form-group m-form__group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control m-input" value="{{ $product->staff_pv_point }}" pattern="(^100(\.0{1,2})?$)|(^([1-9]([0-9])?|0)(\.[0-9]{1,2})?$)"
                                                ...
                                                @if($product->is_variation == '1')
                                                <div id="dynamic_option_edit">
                                                    <input type="hidden" id="attributeArray" name="attributeArray" value="{{json_encode($attributeIds)}}">
                                                        ...
                                                        <div class="form-group m-form__group row dynamic_option" @if($key<=0) id="basic" @else id="basic{{$key}}" @endif>
                                                            ...
                                                            <div class="col-lg-5">
                                                                <div class="form-group m-form__group">
                                                                    ...
                                                                    <input type="text" data-role="tagsinput" @if($key<=0) id="variation" @else id="variation{{$key}}" @endif name="variation[]" class="form-control dynamic-tags" value="{{implode(',' ,$varValue[$attr->id])}}" data-id="{{$productData->attributevariation[$key]['product_attribute_id']}}" >
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="m-form__section m-form__section--first">
                                                    <div class="form-group m-form__group row">
                                                        <div class="col-lg-12">
                                                            <label class="form-control-label">Name in chinese</label>
                                                            <input type="text" name="chinese_name" class="form-control m-input"
                                                            placeholder="Enter name in chinese"
                                                            value="@if (isset($product_chinese->product_name)){{ $product_chinese->product_name }}@endif">
                                                        </div>
                                                    </div>
                                                    <div class="form-group m-form__group row">
                                                        <div class="col-lg-12 form-group m-form__group ">
                                                            ...
                                                            <div class="m-input-icon m-input-icon--right">
                                                                <textarea type="text" class="form-control m-input txarea-height "
                                                                id="description_chinese" name="description_chinese"
                                                                placeholder="Enter description in chinese">@if (isset($product_chinese->product_description)){{ $product_chinese->product_description }}@endif</textarea>
                                                ...
                                                <div class="m-form__section m-form__section--first">
                                                    <div class="form-group m-form__group row">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <input type="text" name="malay_name" class="form-control m-input"
                                                            placeholder="Enter name in malay" value="@if (isset($product_malay->product_name)){{ $product_malay->product_name }}@endif">
                                                        </div>
                                                    </div>
                                                    <div class="form-group m-form__group row">
                                                        <div class="col-lg-12 form-group m-form__group ">
                                                            ...
                                                            <div class="m-input-icon m-input-icon--right">
                                                                ...
                                                                placeholder="Enter description in malay">@if (isset($product_malay->product_description)){{ $product_malay->product_description }}@endif </textarea>
                                                ...
                                                <div class="m-form__section m-form__section--first">
                                                    <div class="form-group m-form__group row">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <input type="text" name="vietnamese_name" class="form-control m-input"
                                                            value="@if (isset($product_vietnamese->product_name)){{ $product_vietnamese->product_name }}@endif"
                                                    ...
                                                    <div class="form-group m-form__group row">
                                                        <div class="col-lg-12 form-group m-form__group ">
                                                            ...
                                                            <div class="m-input-icon m-input-icon--right">
                                                                <textarea type="text" class="form-control m-input txarea-height "
                                                                id="description_vietnamese" name="description_vietnamese"
                                                                placeholder="Enter description in vietnamese">@if (isset($product_vietnamese->product_description)){{ $product_vietnamese->product_description }}@endif</textarea>
                                                ...
                                                <div class="m-form__section m-form__section--first">
                                                    <div class="form-group m-form__group row">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <input type="text" name="thai_name" class="form-control m-input"
                                                            value="@if (isset($product_thai->product_name)){{ $product_thai->product_name }}@endif" placeholder="Enter name in thai">
                                                        </div>
                                                    </div>
                                                    <div class="form-group m-form__group row">
                                                        <div class="col-lg-12 form-group m-form__group ">
                                                            ...
                                                            <div class="m-input-icon m-input-icon--right">
                                                                ...
                                                                placeholder="Enter description in thai">@if (isset($product_thai->product_description)){{ $product_thai->product_description }}@endif</textarea>
...
<script src="{{ asset('script/summernote/summernote-bs4.js') }}"></script>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        //     var html =
        //     '<input type="hidden" name="delete_daynamic_price[]" class="form-control m-input" value="' +
        //     button_id + '">';
        //     $('#remove_edit_price').append(html);
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        is_variable = {{$product->is_variation}};
        if(is_variable == 1){
            $("#dynamic_option-edit").show();
            $("#dynamic_option").hide();
            $("#simple").hide();
            setPrice();
        }else{
...
return {
  ...
  $("#is_variation").change(function () {
    ...
    if(end == 1) {
        ...
        $("#dynamic_option").hide();
        $("#set-variation-div").hide();
        $("#attribute-pricing-row").hide();
    }
});

  function setPrice(){
    var is_variable = {{$product->is_variation}};
    ...
    if(is_variable == 1){
        var url = "{{ route('seller.variations.editPricing') }}";
    }else{
